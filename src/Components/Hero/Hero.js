...
const Hero = () => {
    return (
        <section className="hero">
            ...
            <h2 className="hero_title">Administra y gestiona tus puntos de venta con Naranja ERP</h2>
            <p className="hero_description">Con nuestra <span>solución POS</span> contarás con una herramienta amigable e intuitiva. Podrás facturar, controlar tu inventario, manejar tus gastos, generar tus cuentas
